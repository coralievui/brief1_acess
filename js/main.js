...
function refreshTimer() {
    ...
    document.getElementById('status').textContent = "Le compte à rebours a été défini";
}
...
document.getElementById('start-timer-button').addEventListener('click', (event) => {
    document.getElementById('status').textContent = "Le compte à rebours a été lancé";
    startTimer();
});

// Gestion de l'arrêt du timer
document.getElementById('stop-timer-button').addEventListener('click', (event) => {
    document.getElementById('status').textContent = "Le compte à rebours a été arrêté";
    stopTimer();
